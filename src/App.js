        ...
        <Tab className={({ selected }) =>
                classNames(
                  ...
                  selected
                    ...
                    : 'text-black-100  hover:bg-white/[0.12] hover:text-gray-300 border-b border-r border-gray-300'
                )
              }>Send</Tab>
        <Tab className={({ selected }) =>
                   classNames(
                  ...
                  selected
                    ? 'bg-white  border-t-4 border-blue-500 text-black-100 '
                    : 'text-black-100  hover:bg-white/[0.12] hover:text-gray-300 border-b border-l border-gray-300'
                )
              }>Receive</Tab>
      ...
      <Tab.Panels>
              <Tab.Panel>
                <div>
                  ...
                  {/* form */}
     	<form className="my-4 flex w-full p-3 border-t border-gray-300">
		...
		<button className="flex-2  px-1 md:px-8 rounded-r-lg bg-blue-200  text-blue-600 text-xs md:text-sm font-bold p-4 ">Terra Wallet address</button>
                 ...
                 <div className="my-5  p-3 border-t border-gray-300">
              ...
              <Tab.Panel className="p-1 lg:p-10">
                ...
                <div className="border border-gray-300 my-5 rounded-md">
                  <div className="flex  justify-center ">
                    <img className="h-24 w-24 my-3" src={ barCode } alt="" />
                  </div>
                  <div>
                    <div className="flex items-center pl-2 border-t border-gray-300 ">
                  ...
                  <div className="my-5 pl-5 py-3 border-t border-gray-300">
